...
def upload_file():
    ...
    if file:
        ...
        return redirect(url_for('result', video_info=video_info_json, video_path=video_path))
...
def result():
    ...
    return render_template('result.html', video_url=video_path, video_info=video_info)
